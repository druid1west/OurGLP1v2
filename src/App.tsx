...
const WeeklySummaryGuarded: React.FC = () => (
  <RequirePro>
    <WeeklySummary />
  </RequirePro>
);
            ...
            <AuthProvider>
              <ReminderBadgeProvider>
                <IonRouterOutlet>
                  ...
                  <PrivateRoute exact path="/weeklysummary" component={WeeklySummaryGuarded} />
                  <PrivateRoute exact path="/weekly-summary" component={WeeklySummaryGuarded} />
