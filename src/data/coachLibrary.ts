...
const seeds: Record<CoachCategory, readonly Seed[]> = {
  ...
  'Exercise & Energy': [
    ...
    { q: 'How do I start strength training?', k: ['strength', 'weights', 'resistance'], a: 'Start with simple movements two or three times weekly if appropriate: sit-to-stand, wall pushups, rows, step-ups, or light bands. Keep it comfortable and progress slowly.' },
    ...
    { q: 'Can exercise help a plateau?', k: ['plateau exercise', 'stuck weight'], a: 'Movement can help health and body composition even when scale changes slow. A plateau review should include protein, hydration, sleep, strength, medication schedule, and clinician guidance.' },
  ...
  'Weight Trends': [
    ...
    { q: 'What is a plateau?', k: ['plateau', 'stuck', 'not losing'], a: 'A plateau is a period where trend weight changes slow or pause. Review protein, hydration, movement, sleep, bowel habits, consistency, and medication schedule. Ask your clinician before changing medication plans.' },
    ...
    { q: 'What if I am not losing at all?', k: ['not losing', 'no loss'], a: 'Look for patterns first: intake, protein, hydration, sleep, movement, constipation, and medication consistency. Avoid changing dose yourself. Bring a clear log to your care team.' },
